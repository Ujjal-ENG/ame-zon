    ...
    return (
        <>
            ...
            <div className="w-[300px] h-[510px] rounded-md border-2 border-black relative">
                <img src={img ? img : 'https://picsum.photos/200/300?random=1'} alt={name} className="w-[286px] h-[286px]  mx-auto p-2 rounded-md transition-all hover:scale-110" />

                <h3 className="font-semibold text-2xl p-2">{name ? name.slice(0, 18) + '...' : 'Name does not contains'}</h3>
